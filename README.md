...
## Website Mockup 📱 💻 🖥️
![all-devices-black](https://user-images.githubusercontent.com/98527559/166143599-c4f25310-0a15-4f52-903b-a1bc8e18e3d0.png)
...
Check the live demo [here](https://mavericks-db.github.io/calculator/)👈
...
```
$ git clone git@github.com:mavericks-db/calculator.git
```
...
Feel free to check the [issues page](https://github.com/mavericks-db/calculator/issues).
